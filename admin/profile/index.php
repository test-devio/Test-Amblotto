<?php
    ...
    if(isset($_POST) && !empty($_POST)){
        if(isset($_POST['profile'])){
            ...
            // echo $filename;
            // exit();
            $sql = "UPDATE tb_admin SET firstname = '$firstname',lastname = '$lastname',email = 
            '$email',phone = '$phone' , image = '$filename' WHERE user = '$user'";   
            ...
            <div class="app-card-header p-3 border-bottom-0">
                ...
                <div class="app-card-body px-4 w-100">
                    <div class="item border-bottom py-3">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-auto">
                                ...
                                <div class="item-data"><img id="preview" class="profile-image rounded-circle" src="upload/admin/<?=$_SESSION['image_login']?>" 
                                alt=""></div>
                            </div><!--//col-->
                    ...
                    <div class="item py-3">
                        <div class="row align-items-center">
                            <div class="">
                                <div class="item-label mb-2"><strong>เบอร์โทร</strong></div>
                ...
                <div class="app-card-footer p-4 mt-auto">
                    ...
                    <input type="submit" class="btn app-btn-secondary" value="อัพเดตข้อมูล"/>
                </div><!--//app-card-footer-->  
        ...
        <form action="" method="post">
            <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                    ...
                    <div class="item py-3">
                        <div class="row align-items-center">
                            <div class="">
                                ...
                                <div class="item-data"><input type="text" placeholder="รหัสผ่านเก่า" name="oldpassword" class="form-control"></div>
                            </div><!--//col-->
                        </div><!--//row-->
                    </div><!--//item-->
                    <div class="item py-3">
                        <div class="row align-items-center">
                            <div class="">
                                ...
                                <div class="item-data"><input type="text" placeholder="รหัสผ่านใหม่" name="newpassword" class="form-control"></div>
                            </div><!--//col-->
                        </div><!--//row-->
                    </div><!--//item-->
                    <div class="item py-3">
                        <div class="row align-items-center">
                            <div class="">
                                ...
                                <div class="item-data"><input type="text" placeholder="ยืนยันรหัสผ่านใหม่" name="confirmnewpassword" class="form-control"></div>
                            </div><!--//col-->
                        </div><!--//row-->
                    </div><!--//item-->
                </div><!--//app-card-body-->
                ...
                <div class="app-card-footer p-4 mt-auto">
                    ...
                    <input type="submit" class="btn app-btn-secondary" value="ยืนยัน"/>
                </div><!--//app-card-footer-->
