...
if(isset($_POST) && !empty($_POST)){
    ...
    if($row > 0){
        ...
        $alert = '<script type="text/javascript">';
        $alert .= 'alert("ผิดพลาด! username หรือ password ผิด");';
        $alert .= 'window.location.href = "";';
        $alert .= '</script>';
        echo $alert;
        exit();
			        ...
			        <div class="auth-form-container text-left">
						<form action="" method="post" class="auth-form login-form">         
							<div class="email mb-3">
								<input name="user" type="text" class="form-control signin-email" 
                                placeholder="ชื่อผู้ใช้" required="required">
							</div><!--//form-group-->
							<div class="password mb-3">								
								<input name="pass" type="password" class="form-control 
                                signin-password" placeholder="รหัสผ่าน" required="required">
						...
						<!-- <div class="auth-option text-center pt-5">No Account? Sign up 
                            <a class="text-link" href="signup.html" >here</a>.</div> -->
			    ...
			    <footer class="app-auth-footer">
				    <div class="container text-center py-3">
                        ...
                        <small class="copyright">
			                ระบบแคตตาล็อก <span class="sr-only">love</span><i class="fas fa-heart" style="color: #fb866a;"></i> by <a class="app-link" href="http://themes.3rdwavemedia.com" target="_blank"></a>พัฒนาโดย developers
                        </small>
			    ...
			    <div class="d-flex flex-column align-content-end h-100">
				    ...
				    <!-- <div class="overlay-content p-3 p-lg-4 rounded">
					    ...
					    <div>Portal is a free Bootstrap 5 admin dashboard template. You can download and view the template license 
                            <a href="https://themes.3rdwavemedia.com/bootstrap-templates/admin-dashboard/portal-free-bootstrap-admin-dashboard-template-for-developers/">here                                
                            </a>.
                        </div> 
				    </div> -->
				</div>
