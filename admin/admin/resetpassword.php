...
if(isset($_GET['id']) && !empty($_GET['id'])){
    ...
    if($pass != $confirmpass){
        ...
        if(mysqli_query($connection, $sql)) {
            ...
            $alert = '<script type="text/javascript">';
            $alert .= 'alert("รีเซ็ตรหัสผ่านสำเร็จ : '.$result['user'].'");';
...
<div class="row justify-content-between">
    <div class="col-auto">
    <h1 class="app-page-title mb-0">รีเซ็ทรหัสผ่าน : <?=$result['user']?></h1>
    </div>
    <div class="col-auto">
                ...
                <div class="app-card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="pass" placeholder="รหัสผ่านใหม่" autocomplete="off" 
                            required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">ยืนยันรหัสผ่านใหม่</label>
                            <input type="text" class="form-control" name="confirmpass" placeholder="ยืนยันรหัสผ่านใหม่" autocomplete="off" 
                            required>
                        </div>                         
